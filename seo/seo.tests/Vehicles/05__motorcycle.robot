...
Suite Setup                                            Create Initial Data           category=وسایل نقلیه                 subcategory=موتور سیکلت
...
Set The Seo Rules Values
    ...
    ...  adsCount=${Count}  Type=${Type}  locationName=${data}[0][2]   categoryName=${data}[1]  bodyType=${EMPTY}   paymentType=${EMPTY}
