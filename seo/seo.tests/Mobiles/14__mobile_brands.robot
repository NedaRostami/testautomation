...
Suite Setup                                            Create Initial Data           category=موبایل، تبلت و لوازم      subcategory=موبایل و تبلت
...
*** Test Cases ***
Validate Seo Description And Title For Mobile Brands
    [Tags]                                             mobile  brands
...
Create Initial Data
    ...
    ${Location_List}                                    Make Locations List           province_count=${province_count}       city_count=${city_count}
