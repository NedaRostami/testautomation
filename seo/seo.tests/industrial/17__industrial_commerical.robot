...
Suite Setup                                            Create Initial Data                               category=صنعتی، اداری و تجاری
Test Setup                                             Set Test Environment
Test Template                                          Validate Seo Rules of ${data}
Force Tags                                             Seo
Test Teardown                                          TearDown Tasks
# Test Teardown                                          Analyze Test
*** Variables ***
${Child_Type}                                          general
${Parent_Type}                                         industrial_commerical
...
*** Test Cases ***
Validate Seo Description And Title For Industrial Commerical
    [Tags]                                              Industrial
